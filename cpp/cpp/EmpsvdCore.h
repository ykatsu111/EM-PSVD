...
public:
	...
	double get_loglikelihood(Eigen::ArrayXXd& const theta);

	Eigen::ArrayXd x, y;
	Eigen::ArrayXXd theta;
	Eigen::ArrayXXd gamma;
	unsigned int k, n;
	unsigned int const m = 6;
...
private:
	...
	static Eigen::ArrayXXd calc_log_pxy(Eigen::ArrayXd& const x, Eigen::ArrayXd& const y, Eigen::ArrayXXd& const theta);
	static Eigen::ArrayXXd calc_pxy(Eigen::ArrayXd& const x, Eigen::ArrayXd& const y, Eigen::ArrayXXd& const theta);
	static double digammad(double a);
	Eigen::ArrayXXd get_log_pxy();
	Eigen::ArrayXXd get_log_pxy(Eigen::ArrayXXd& const theta);
	Eigen::ArrayXXd get_pxy();
	Eigen::ArrayXXd get_pxy(Eigen::ArrayXXd& const theta);
	...
	Eigen::ArrayXXd get_gamma(Eigen::ArrayXXd& const theta);

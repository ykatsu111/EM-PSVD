...
PYBIND11_MODULE(pyempsvd, mod) {
	...
	py::class_<Empsvd::EmpsvdCore>(mod, "EmpsvdCore")
		.def(py::init<size_t, Eigen::ArrayXd, Eigen::ArrayXd, size_t, Eigen::ArrayXd, double, bool, bool>(),
			py::arg("k"), py::arg("x"), py::arg("y"), py::arg("theta0"),
			py::arg("max_iter") = 1000, py::arg("tol") = 1e-2, py::arg("fix_alpha") = false, py::arg("fix_ab") = false)
		.def(py::init<size_t, Eigen::ArrayXd, Eigen::ArrayXd, size_t, double, bool, bool>(),
			py::arg("k"), py::arg("x"), py::arg("y"),
			py::arg("max_iter") = 1000, py::arg("tol") = 1e-2, py::arg("fix_alpha") = false, py::arg("fix_ab") = false)
		.def(py::init<size_t, Eigen::ArrayXd, Eigen::ArrayXd, Eigen::ArrayXd, size_t, Eigen::ArrayXd, double, bool, bool>(),
			py::arg("k"), py::arg("x"), py::arg("y"), py::arg("z"), py::arg("theta0"),
			py::arg("max_iter") = 1000, py::arg("tol") = 1e-2, py::arg("fix_alpha") = false, py::arg("fix_ab") = false)
		.def(py::init<size_t, Eigen::ArrayXd, Eigen::ArrayXd, Eigen::ArrayXd, size_t, double, bool, bool>(),
		...
		.def_static("make_theta0", &Empsvd::EmpsvdCore::make_theta0, py::arg("k"), py::arg("x"), py::arg("y"), py::arg("z"))
		.def_static("make_theta0", &Empsvd::EmpsvdCore::make_theta0, py::arg("k"), py::arg("x"), py::arg("y"))

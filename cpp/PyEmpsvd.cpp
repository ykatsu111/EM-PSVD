...
PYBIND11_MODULE(empsvd, mod) {
	...
	py::class_<Empsvd::EmpsvdCore>(mod, "Empsvd")
		...
		.def("get_aic", &Empsvd::EmpsvdCore::get_aic, py::return_value_policy::reference_internal)
		.def("get_bic", &Empsvd::EmpsvdCore::get_bic, py::return_value_policy::reference_internal)
		.def("get_loglikelihood", &Empsvd::EmpsvdCore::get_loglikelihood, py::return_value_policy::reference_internal)
		.def("get_loglikelihood", &Empsvd::EmpsvdCore::get_loglikelihood, py::arg("theta"), py::return_value_policy::reference_internal)
		...
		.def_readonly("m", &Empsvd::EmpsvdCore::m)
